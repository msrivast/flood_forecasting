...
df_ws2 = df_ws2[df_ws2["datetime"]>pd.Timestamp("2022-4-15 18:00")]
...
df_ws3 = df_ws3.resample('15T', label = 'right', closed = 'right').sum(min_count=1) # writes 0 for no data -> 10/13 - 10/19 and no data before march
...
df_1697 = df_1697.resample('15T', label = 'right', closed = 'right').min()
